...
class Solution {
    public int[] nodesBetweenCriticalPoints(ListNode head) {
        ...
        while(curr.next != null) { // logic to find critical point
            if((curr.val < prev.val && curr.val < curr.next.val) ||//CriticalPoint
            (curr.val > prev.val && curr.val > curr.next.val)) {//CriticalPoint
